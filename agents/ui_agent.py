...
class UIAgent:
    ...
    def __init__(self, app) -> None:
        ...
        self.style.configure('.', background='#2e2e2e', foreground='#d3d3d3', font=('Segoe UI', 10))
        ...
        self.style.configure('TNotebook.Tab', background='#3e3e3e', foreground='#d3d3d3')
    ...
    def setup_menu(self) -> None:
        ...
        tools_menu.add_command(label="Hotkey Manager", command=self.app.hotkeys.open_manager)
